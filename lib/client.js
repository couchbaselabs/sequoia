...
exports.api = (function(){
    ...
    return {
		...
		getContainerIps: function(_type){
			if(_type){
                /*return {
                    'local-1.st.couchbase.com': 'kvm-s638.sc.couchbase.com',
                    'local-2.st.couchbase.com': 'kvm-s637.sc.couchbase.com',
                    'local-3.st.couchbase.com': 'xcp-s731.sc.couchbase.com',
                    'local-4.st.couchbase.com': 'kvm-s713.sc.couchbase.com'
                }*/
