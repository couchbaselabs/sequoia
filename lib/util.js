...
exports.api = (function(){
    ...
    return {
        ...
        mapHostsToServices: function(serviceSpec, numNodes){
            ...
            var indexStartPos = numNodes - numQueryNodes - numIndexNodes
            if (indexStartPos < 0){ indexStartPos = 0}

            var queryStartPos = numNodes - numQueryNodes 
            if (queryStartPos < 0){ queryStartPos = 0}
